...
namespace Epam.JDI.Web.Selenium.Elements.WebActions
{
    public class ActionInvoker
    {
        ...
        public TResult DoJActionResult<TResult>(string actionName, Func<TResult> action,
        ...
        public void DoJAction(string actionName, Action action, LogLevels level = LogLevels.Info)
        {
